...
| **Deutsch (German)** | [德文編譯與建置完整指南](docs/build/BUILD_de.md) |
| **Español (Spanish)** | [西班牙文編譯與建置完整指南](docs/build/BUILD_es.md) |
| **Français (French)** | [法文編譯與建置完整指南](docs/build/BUILD_fr.md) |
