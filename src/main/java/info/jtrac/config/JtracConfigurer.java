 ...
 *     <ul>
 *       <li>switches between embedded HSQLDB or HikariCP (connection pool)</li>
...
public class JtracConfigurer extends PropertyPlaceholderConfigurer implements ServletContextAware {
    ...
    private void configureJtrac() throws Exception {
        ...
        if (jtracHome == null) {
            logger.info("valid 'jtrac.home' property not available in system properties, trying servlet init parameters.");
        ...
        if (jtracHome == null) {
            ...
            logger.warn("Servlet init parameter 'jtrac.home' does not exist. Will use 'user.home' directory '" + jtracHome + "'");
        }
        //======================================================================
