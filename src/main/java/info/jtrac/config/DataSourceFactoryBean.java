 ...
 *    <li>Java Naming and Directory Interface (JNDI); supported by most JDBC database drivers</li>
 * </ul>
 */
public class DataSourceFactoryBean implements FactoryBean, DisposableBean {
     ...
     *
     * @return Returns the class name <code>Object.class</code> of the DataSource object.
    ...
    /**
     * This method is called to clean up the references when the object is destroyed.
     *
     * @throws Exception
    ...
    public void destroy() throws Exception {
        if(dataSource instanceof SingleConnectionDataSource) {
            ...
            logger.info("attempting to close HikariCP data source");
            ((HikariDataSource) dataSource).close();
            logger.info("HikariCP data source closed successfully");
        } else {
