...
public class UserFormPage extends BasePage {
    ...
    private class UserForm extends Form {
        ...
        public UserForm(String id, final User user) {
            ...
            add(localeChoice);
            // pretty dates ====================================================
			add(new CheckBox("user.prettyDates"));
            ...
            add(new AbstractFormValidator() {
                ...
                public void validate(Form form) {
                    ...
                    if ((a != null && !a.equals(b)) || (b!= null && !b.equals(a))) {
						...
						int pwdMinLength = 8;
						String pwdMinLenStr = getJtrac().loadConfig("pwd.minLength");
						if (StringUtils.hasText(pwdMinLenStr))
							try {
								pwdMinLength = Integer.parseInt(pwdMinLenStr);
							} catch (NumberFormatException nfex) { /* ignore */ }
						if (a.length() < pwdMinLength)
							confirmPasswordField.error(localize("user_form.passwordTooShort.error", Integer.valueOf(pwdMinLength)));
					}
                }
            });
            // send notifications ==============================================
