        ...
        ListView listView = new ListView("fields", fields) {
            protected void populateItem(ListItem listItem) {
                ...
                if (field.isDropDownType()) {
                     ...
                     * ======================================
                     */
                    Fragment f = new Fragment("field", "dateField", CustomFieldsFormPanel.this);
                    DateField dateField = new DateField("field");
					dateField.setRequired(isRequired);
                    dateField.setLabel(new Model(field.getLabel()));
					dateField.add(new ErrorHighlighter());
                    f.add(model.bind(dateField, field.getName().getText()));
                    listItem.add(f);
                } else {
                    /*
                     * ======================================
                    ...
                    /*
                     * Check if the field is used to display/edit Double values.
                     */
