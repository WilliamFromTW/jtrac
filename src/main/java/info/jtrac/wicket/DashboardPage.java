...
public class DashboardPage extends BasePage {
    ...
    public DashboardPage() {
		...
		// remove spaces that are not active
		spaceRoles = spaceRoles.stream()
						.filter(spaceRole -> spaceRole.getSpace().getIsActive())
        ...
        add(new ListView("links", links) {
            protected void populateItem (ListItem listItem) {
                ...
                if (storedSearch != null) {
                    ExternalLink link = new ExternalLink("externalLink", storedSearch.getQuery(), storedSearch.getName());
					if (storedSearch.getNewWindow()) {
