...
/**
 * Compatibility adapter for Wicket 1.3 HeaderContributor in Wicket 9
 */
public class HeaderContributor extends Behavior {
    ...
    public HeaderContributor(IHeaderContributor contributor) {
    ...
    public static Behavior forCss(String url) {
        return new Behavior() {
            private static final long serialVersionUID = 1L;
            @Override
            public void renderHead(Component component, IHeaderResponse response) {
    ...
    public static Behavior forJavaScript(String url) {
        return new Behavior() {
            private static final long serialVersionUID = 1L;
            @Override
            public void renderHead(Component component, IHeaderResponse response) {
