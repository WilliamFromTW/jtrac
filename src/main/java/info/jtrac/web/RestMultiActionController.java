...
public class RestMultiActionController extends AbstractMultiActionController {
    ...
    /**
     * custom MethodNameResolver is configured that checks the value of an expected parameter
	 * called "method" in the request and formats the value that may be in the form of
	 * "namespace.subnamespace.action" into "namespaceSubnamespaceAction" or more like a Java method name
     */
