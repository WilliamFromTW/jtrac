...
public class OllamaPromptBuilder {
    ...
    public static final String DEFAULT_SYSTEM_PROMPT =
            ...
            + "5. If the provided tickets and attachments do not contain sufficient info to answer the question, clearly state what was found and what is missing.\n"
            + "6. Never fabricate ticket details, statuses, or resolutions that do not exist in the provided context.\n"
            + "\n"
