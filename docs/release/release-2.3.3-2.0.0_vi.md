# Ghi chú Phát hành JTrac (Release Notes) - 2.3.3-2.0.0
...
- **Phiên bản tiếp theo (Bản xem trước)**: [Ghi chú Phát hành JTrac - 2.3.3-2.1.0-beta](release-2.3.3-2.1.0_vi.md)
- **Phiên bản trước**: [Ghi chú Phát hành JTrac - 2.3.3-1.0.0](release-2.3.3-1.0.0_vi.md)
