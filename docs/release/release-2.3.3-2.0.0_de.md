...
- **Nächste Version (Vorschau)**: [JTrac Versionshinweise - 2.3.3-2.1.0-beta](release-2.3.3-2.1.0_de.md)
- **Vorherige Version**: [JTrac Versionshinweise - 2.3.3-1.0.0](release-2.3.3-1.0.0_de.md)
