...
Dieser Leitfaden beschreibt ausführlich die Kompilierung und das Packaging des JTrac 2.3.3-2.0.0-Projekts mit Apache Maven. Er behandelt den Maven-Lebenszyklus, das Abhängigkeitscaching, die WAR- und CLI-Paketstrukturen, die Web-Container-Verifikationsmatrix sowie die Fehlerbehebung beim Build.
...
JTrac 2.3.3-2.0.0 entspricht der Servlet 4.0-Spezifikation (`javax.servlet`). Das erstellte WAR kann direkt auf modernen Web-Containern bereitgestellt werden:
