...
Tài liệu này hướng dẫn chi tiết cách sử dụng Apache Maven để biên dịch và đóng gói dự án JTrac 2.3.3-2.0.0, phân tích vòng đời Maven, cơ chế lưu bộ nhớ đệm thư viện, cấu trúc gói WAR và CLI, ma trận kiểm thử Web Container và xử lý sự cố biên dịch.
...
JTrac 2.3.3-2.0.0 tuân thủ chuẩn Servlet 4.0 (`javax.servlet`). Tệp WAR có thể triển khai trực tiếp trên các máy chủ hiện đại:
