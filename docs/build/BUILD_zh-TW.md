...
本指南詳細說明如何使用 Apache Maven 編譯與打包 JTrac 2.3.3-2.0.0 專案，深入解析 Maven 生命週期、依賴快取管理、WAR 與 CLI 封裝結構、Web 容器驗證矩陣，以及常見編譯問題之排除指引。
...
JTrac 2.3.3-2.0.0 核心採用 Servlet 4.0 規範（`javax.servlet`），編譯完成後之 WAR 檔可直接部署至主流現代 Web 容器：
