...
All detailed project specifications, technical guides, and multilingual documentation are organized in this directory:

- **Build & Compilation Guides (8 Languages)**: [`build/BUILD_en.md`](build/BUILD_en.md)
- **System Administrator Guides (8 Languages)**: [`admin/ADMIN_GUIDE_en.md`](admin/ADMIN_GUIDE_en.md)
